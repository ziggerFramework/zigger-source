...
<?php } ?>
<link rel="stylesheet" href="<?php echo PH_DIR; ?>/layout/css/jquery.common.css?<?php echo date('Ymd'); ?>" />
<link rel="stylesheet" href="<?php echo PH_DIR; ?>/layout/css/common.css?<?php echo date('Ymd'); ?>" />
<link rel="stylesheet" href="<?php echo PH_THEME_DIR; ?>/layout/css/layout.css?<?php echo date('Ymd'); ?>" />
<?php if($use_respd===true){ ?>
<link rel="stylesheet" href="<?php echo PH_THEME_DIR; ?>/layout/css/respond.css?<?php echo date('Ymd'); ?>" />
<?php } ?>
<link rel="stylesheet" href="<?php echo PH_PLUGIN_DIR; ?>/<?php echo PH_PLUGIN_CKEDITOR; ?>/contents_view.css?<?php echo date('Ymd'); ?>" />
<?php
//모듈별 CSS
foreach ($MODULE as $key => $value) {
  $file = PH_THEME_PATH."/mod-".$value."/style.css";
  if (file_exists($file)) {
    echo '<link rel="stylesheet" href="'.PH_THEME_DIR.'/mod-'.$value.'/style.css?'.date('Ymd').'"/>'.PHP_EOL;
	}
}
?>
...
<script src="<?php echo PH_DIR; ?>/layout/js/jquery.min.js?<?php echo date('Ymd'); ?>"></script>
<script src="<?php echo PH_DIR; ?>/layout/js/jquery.common.js?<?php echo date('Ymd'); ?>"></script>
<script src="<?php echo PH_DIR; ?>/layout/js/common.js?<?php echo date('Ymd'); ?>"></script>
<script src="<?php echo PH_DIR; ?>/layout/js/global.js?<?php echo date('Ymd'); ?>"></script>
<script src="<?php echo PH_THEME_DIR; ?>/layout/js/layout.js?<?php echo date('Ymd'); ?>"></script>
<script src="<?php echo PH_PLUGIN_DIR; ?>/<?php echo PH_PLUGIN_CKEDITOR; ?>/ckeditor.js?<?php echo date('Ymd'); ?>"></script>
<?php
//모듈별 JS
foreach ($MODULE as $key => $value) {
  $file = PH_THEME_PATH."/mod-".$value."/script.js";
  if (file_exists($file)) {
      echo '<script src="'.PH_THEME_DIR.'/mod-'.$value.'/script.js?'.date('Ymd').'"></script>'.PHP_EOL;
  }
}
//Script 소스코드 설정 반영
if ($CONF['script']) {
